       ...
       <?php if ($ar_enabled === ''):?>
        ...
        <?php if ($scoring->data->analysis): ?>
            ...
            <?php if ($total_topics > 0): ?>
                                        <div><a href="#tg"><?php echo $total_topics; ?> Keyword<?php echo ($total_topics == 1) ? '' : 's'; ?> representing the topics of your post</a></div>
                                        <div>
                                            <ul class="details">
                                                <?php
                                                $ul_tg = '';
            ...
            <?php endif; ?>
                                ...
                                switch ($state) {
                                    case 'green':
                                        echo '<li class="ar_checkmarks_passed"><div>Length of post is ' . $ms . ' sentences, which meets the minimum recommended length of ' . $rs . '-85 sentences.</div></li>';
                                        break;
                                    case 'yellow':
                                        echo '<li class="ar_checkmarks_warning"><div>Length of post is ' . $ms . ' sentences. For text based posts our recommended range is '.$rs.'-85 sentences for greater engagement.</div></li>';
                                        break;
                                    case 'red':
                                        echo '<li class="ar_checkmarks_error"><div>Length of post is ' . $ms . ' sentences. For text based posts our recommended range is '.$rs.'-85 sentences for greater engagement.</div></li>';
                                        break;
                                }
                                ?>
            ...
            <?php endif; ?>
                ...
                <?php if (strtolower($scoring->data->analysis->so->state) !== 'green'): ?>
                                    ...
                                    <p class="ar-message">
                                        <strong>If your content is too complex,</strong> consider writing shorter sentences, breaking up long paragraphs and/ or using simpler language.<br /><strong>
                                        If your content is too simple,</strong> consider elaborating on short sentences and/ or use more sophisticated language.
                                    </p>
						  		<br /><br />
            ...
            <?php endif; ?>
                                ...
                                <!-- Emotion -->
                                    ...
                                    <li class="ar_checkmarks_warning"><div>Your content could evoke more emotion to excite and engage your readers. It should include more stimulating language, portrayed through positive and/or negative words.</div>
